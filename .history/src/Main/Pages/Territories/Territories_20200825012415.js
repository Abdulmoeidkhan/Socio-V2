                            ...
                            <div className="terr-section-parent">
                                ...
                                <section className="equal-columns-grid">
                                    <div className="content-content-1">
                                        <div className="spacing-class" />
                                        <p className="content-super" data-aos-duration="800" data-aos={"zoom-in"} data-aos-delay="200">About</p>
                                        <h2 className="content-head" data-aos-duration="800" data-aos={"zoom-in"} data-aos-delay="400">BALOCHISTAN</h2>
                                        <p className="content-para" data-aos-duration="900" data-aos={"zoom-in"} data-aos-delay="500"> Balochistan, also spelled Balūchistān, westernmost province of Pakistan. It is bordered by Iran (west), by Afghanistan (northwest), by Khyber Pakhtunkhwa and Punjab provinces (northeast and east), by Sindh province (southeast), and by the Arabian Sea (south).</p>
                                    </div>
                                    <div>
