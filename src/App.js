...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="arrowDownKey" onClick={() => { window.scrollTo({ top: 15000, left: 0, behavior: "smooth" }) }}><i className="fa fa-x fa-arrow-down" style={{ color: "#fff" }} aria-hidden="true"></i></div>
    </div>
  )
}
