...
export const calenderData = [
    ...
    },
    {
        ...
        Desc:"Literacy is usually defined as being able to read and write. However, there are different aspects of reading and writing which varies culture to culture and country to country. Because of these differences we see varieties of literature over the regions., Literacy is the most important and basic ability of a person, being able to read and write is a skill required in day to day life. It helps a person to function properly in social engagements and communication., Literacy is the ability to identify, understand, interpret, create, communicate and compute, using printed and written materials associated with varying contexts., Unfortunately, there are many people who are unable to read and understand writing which comes in many factors some of them are listed below.Poverty Lack of exposure Lack of stimulation Less educated parentsLearning disabilities etc., Therefore, since 1967 UN has started to celebrate International Literacy day (ILD) every year on September 8th to promote awareness about the importance of literacy and appreciating those organizations and programs which are working to eliminate illiteracy. Every year on this day UNESCO holds an awards ceremony in Paris in which prizes are given to individuals and organisations who work hard to increase literacy around the world., The United Nations Educational, Scientific and Cultural Organisation (UNESCO) and its partners promote the day to underline the significance of literacy for healthy societies, with a strong emphasis on epidemics and communicable diseases such as HIV, tuberculosis and malaria., According to UNESCO, about 774 million adults lack the minimum literacy skills. One in five adults is still not literate and two-thirds of them are women. About 75 million children are out-of-school and many more attend irregularly or drop out.,However, literacy is also a cause for celebration on the day because there are nearly four billion literate people in the world.,In Pakistan, the National commission of Human Development has a prior motive of ‘Education for All’ and is primarily working for universal primary education and adult literacy along with assisting the Government of Pakistan to achieve MDGs (Millennium Development Goals) and EFA (Education for All) goals. The Literacy rate of Pakistan is currently Pakistan literacy rate for 2017 was 59.13%, a 2.15% increase from 2014.,There are many organizations working to prevent illiteracy especially in rural areas where people are unaware of education and do not consider it significant and viable. This international day aims to confront as many problems related to literacy and ensure education for everyone.,",
    },
    {
        Date: "09-21",
