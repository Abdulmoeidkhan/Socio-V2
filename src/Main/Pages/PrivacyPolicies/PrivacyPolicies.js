...
const PrivacyPolicies = (props) => {
    return (
                <Layout>
                    ...
                    <Content>
                        <div style={{ margin: '10px 16px' }}>
                            <section>
                                <h2 className="content-sub-head">Privacy Policy</h2>
                                <div>
                                    Thank you for choosing to be part of our community at Socio-Linkage (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at sociolinkage@gmail.com.
                </div>
                                <br />
                                <div>
                                    When you visit our website socio-linkage.digital (the "Website"), use our mobile application, use our Facebook application, as the case may be (the "App") and more generally, use any of our services (the "Services", which include the Website and App), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.
                </div>
                                <br />
                                <div>
                                ...
                                <h4 className="content-sub-head" id="PP1">1. WHAT INFORMATION DO WE COLLECT?</h4>
                    ...
                    <br />
                    he personal information that we collect depends on the context of your interactions with us and the Services, the choices you make and the products and features you use. The personal information we collect may include the following:
                    <strong>
                                        Personal Information Provided by You.
                    </strong>
                    e collect names; phone numbers; email addresses; job titles; usernames; passwords; contact preferences; billing addresses; debit/credit card numbers; contact or authentication data; mailing addresses; and other similar information.
                    <strong>
                    ...
                    <ul>
                         ...
                         We collect information regarding your geo-location, push notifications, and Facebook permissions when you use our App.
                        <br />
                    ...
                    <br />
                                    <ul>
                                        ...
                                        <div>The information is primarily needed to maintain the security and operation of our App, for troubleshooting and for our internal analytics and reporting purposes.</div>
                                    </ul>
                                </div>
                                <h4 className="content-sub-head">Information collected from other sources</h4>
                                <div>
                                    <strong>
                                        In Short:
                    </strong>
                    ...
                    In order to enhance our ability to provide relevant marketing, offers and services to you and update our records, we may obtain information about you from other sources, such as public databases, joint marketing partners, affiliate programs, data providers, social media platforms, as well as from other third parties. This information includes mailing addresses, job titles, email addresses, phone numbers, intent data (or user behavior data), Internet Protocol (IP) addresses, social media profiles, social media URLs and custom profiles, for purposes of targeted advertising and event promotion. If you interact with us on a social media platform using your social media account (e.g. Facebook or Twitter), we receive personal information about you such as your name, email address, and gender. Any personal information that we collect from your social media account depends on your social media account's privacy settings.
                                ...
                                <h4 className="content-sub-head" id="PP2">2.  HOW DO WE USE YOUR INFORMATION?</h4>
                                <div>
                                    <strong>
                                        In Short:
                        </strong>
                        ...
                        <ul>
                            ...
                            We and/or our third-party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. For example, when expressing an interest in obtaining information about us or our Services, subscribing to marketing or otherwise contacting us, we will collect personal information from you. You can opt-out of our marketing emails at any time (see the
                                <a href="#PP10">
                                                WHAT ARE YOUR PRIVACY RIGHTS?
                                </a>
                             below).
                            ...
                            We may use your information for other business purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Services, products, marketing and your experience. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.
                                ...
                                <h4 className="content-sub-head" id="PP3">3.  WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h4>
                                <div>
                                    <strong>
                                        In Short:
                        </strong>
                        ...
                        <ol>
                            ...
                            We may share your information with our affiliates, in which case we will require those affiliates to honor this privacy notice. Affiliates include our parent company and any subsidiaries, joint venture partners or other companies that we control or that are under common control with us.
                                ...
                                <h4 className="content-sub-head" id="PP4">4.  WHO WILL YOUR INFORMATION BE SHARED WITH?</h4>
                                <div>
                                    <strong>
                                        In Short:
                        </strong>
                        ...
                        <ul>
                                        ...
                                        <li>
                                            ...
                                            <div>Facebook advertising</div>
                                        </li>
                                        <li>
                                            <strong>User Account Registration and Authentication</strong>
                                            <div>Google Sign-In, Facebook Login and Firebase Authentication</div>
                                        </li>
                                        <li>
                                            <strong>
                                ...
                                <h4 className="content-sub-head" id="PP5">5.  DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h4>
                                <div>
                                    <strong>In Short:</strong>
                    ...
                    We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice.
                                ...
                                <h4 className="content-sub-head" id="PP6">6.  DO WE USE GOOGLE MAPS?</h4>
                                <div>
                                    <strong>In Short:</strong>
                    Yes, we use Google Maps for the purpose of providing better service.
                    <br />
                    This Website or App uses Google Maps APIs which is subject to Google's Terms of Service. You may find the Google Maps APIs Terms of Service <a href="https://cloud.google.com/maps-platform/terms/">here</a>. To find out more about Google’s Privacy Policy, please refer to this<a href="https://policies.google.com/privacy">link</a>.
                </div>
                                <h4 className="content-sub-head" id="PP7">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h4>
                                <div>
                                    <strong>In Short:</strong>
                ...
                We will use the information we receive only for the purposes that are described in this privacy notice or that are otherwise made clear to you on the relevant Services. Please note that we do not control, and are not responsible for, other uses of your personal information by your third-party social media provider. We recommend that you review their privacy notice to understand how they collect, use and share your personal information, and how you can set your privacy preferences on their sites and apps.
                                ...
                                <h4 className="content-sub-head" id="PP8">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h4>
                                <div>
                                    <strong>In Short:</strong>
                ...
                When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize such information, or, if this is not possible (for example, because your personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing until deletion is possible.
                                ...
                                <h4 className="content-sub-head" id="PP9">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h4>
                                <div>
                                    <strong>In Short:</strong>
                ...
                We have implemented appropriate technical and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security, and improperly collect, access, steal, or modify your information. Although we will do our best to protect your personal information, transmission of personal information to and from our Services is at your own risk. You should only access the Services within a secure environment.
                                ...
                                <h4 className="content-sub-head" id="PP10">10. WHAT ARE YOUR PRIVACY RIGHTS?</h4>
                                <div>
                                    <strong>In Short:</strong>
                You may review, change, or terminate your account at any time.
                <br />
                If you are resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.html">http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.html</a>
                                    <br />
                ...
                You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list – however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may:
                                ...
                                <h4 className="content-sub-head" id="PP11">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h4>
                                <div>
                ...
                Socio-Linkage
                <br />
                Nazish Heaven, Gulshan-e-Iqbal Block 11, Karachi, Pakistan
                <br />
                Karachi, Sindh 75300
                <br />
                Pakistan
                </div>
                                <h4 className="content-sub-head" >HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h4>
                                <div>
                                    Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking <a href="https://app.termly.io/notify/9c353c91-63f7-4165-8982-55e3fda0b8fe">here</a>. We will respond to your request within 30 days.
                </div>
                            </section>
                        </div>
                    </Content>
