                                    ...
                                    <div className="card-background-class">
                                        ...
                                        <div className="card-container-class">
                                            ...
                                            <div className="five-column-seperation">
                                                ...
                                                <Card bordered={true} className="first-page-card-class" onClick={() => history.push("/TheGraphicGuru")}>
                                                    <Meta avatar={<Avatar src="https://res.cloudinary.com/tanzeelah/image/upload/v1596538345/Flashcards/Icons/TheGraphicGuru_xhzv4b.png" />} />
                                                    <h2 className="content-sub-head">TheGraphicGuru</h2>
                                                    <p>
                                                        From connecting our clients to organizations, to representing and marketing your organizations on different various social media platforms with wide audiences our TheGraphicGuru (Social Media Marketing) Team is determined to raise your organization to the next level!
                                                </p>
                                                </Card>
                                                <Card bordered={true} className="first-page-card-class" onClick={() => history.push("/TheGraphicGuru")}>
