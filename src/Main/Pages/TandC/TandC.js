                ...
                <Layout>
                    ...
                    <Content>
                        <div style={{ margin: '10px 16px' }}>
                            <section>
                                <h2 className="content-sub-head">TERMS AND CONDITIONS</h2>
                                <ol>
                                    <li>
                                        <h3 className="content-sub-head">Agreement to Terms</h3>
                                        <ol>
                                            <li>
                                                These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Socio-Linkage , located at C-22,Nazish Heaven, Block-11, Gulshan-e-Iqbal,Karachi,   Karachi, Sindh  75300 Pakistan  (we, us), concerning your access to and use of the Socio-Linkage (
                                <a bref="http://socio-linkage.digital">http://socio-linkage.digital</a>
                                ...
                                If you do not agree with all of these Terms and Conditions, then you are prohibited from using the Site and Services and you must discontinue use immediately. We recommend that you print a copy of these Terms and Conditions for future reference.
                                            ...
                                            <li>
                                                Our site is directed to people residing in Pakistan. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.
                            </li>
                                            <li>
                            ...
                            <ul>
                                                    <li>
                                                        Our Privacy Notice socio-linkage.digital, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate.
                                </li>
                                                    <li>
                                                        Our Acceptable Use Policy socio-linkage.digital, which sets out the permitted uses and prohibited uses of the Site. When using the Site, you must comply with this Acceptable Use Policy.
                                </li>
                                                    <li>
                                    ...
                                    <li>
                                        <h3 className="content-sub-head">Acceptable Use  </h3>
                                        <ol>
                                            <li>
                                                Our full Acceptable Use Policy socio-linkage.digital, sets out all the permitted uses and prohibited uses of this site.
                                <br />
                                ...
                                <ul>
                                                    ...
                                                    <li>
                                                        Organizations and NGOs will be entitled to allow us monitoring
                                    </li>
                                                    <li>
                                                        NGOs must notify us for any major changes in their methodologies
                                    </li>
                                                    <li>
                                                        NGOs must ensure the safety and privacy of our clients
                                    </li>
                                                    <li>
                                                        The clients must keep Socio-Linkage as their primary source at all times
                                    </li>
                                                    <li>
                                                        The clients are entitled to inform Socio-Linkage before hand in order to terminate the availing of our services
                                    </li>
                                                    <li>
                                                        Any employee of Socio-Linkage shall be on a probationary period of 90 days upon joining during which the employees employment can be altered or terminated with or without reason
                                    </li>
                                                    <li>
                                    ...
                                    <li>
                                        <h3 className="content-sub-head">Information you provide to us </h3>
                                        <ol>
                                            <li>
                                ...
                                <br />
                                If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at sociolinkage@gmail.com.
                                <br />
                                            </li>
                                            <li>
                                ...
                                You acknowledge and agree that we may access your email address book associated with a Third Party Account and your contacts list stored on your mobile device or tablet computer solely for purposes of identifying and informing you of those contacts who have also registered to use the Site. At your email request to sociolinkage@gmail.com or through your account settings (if applicable), we will deactivate the connection between the Site and your Third Party Account and attempt to delete any information stored on our servers that was obtained through such Third Party Account, except the username and profile picture that became associated with your account.
                                    ...
                                    <li>
                                        ...
                                        <ol>
                                            ...
                                            <li>
                                                If you wish to complain about User Content uploaded by other users please contact us at sociolinkage@gmail.com.
                        </li>
                                        </ol>
                                    </li>
                                    <li>
                                        <h3 className="content-sub-head">Our content </h3>
                                        <ol>
                            ...
                            <br />
                                ...
                                Notwithstanding anything to the contrary contained in the Disclaimer/Limitation of Liability section, our liability to you for any cause whatsoever and regardless of the form of the action, will at all times be limited to a total aggregate amount equal to the greater of (a) the sum of £ 0 or (b) the amount paid, if any, by you to us for the Services/Site during the six (6) month period prior to any cause of action arising.
                                    ...
                                    <li>
                                        <h3 className="content-sub-head">Term and Termination </h3>
                                        <ol>
                                            <li>These Terms and Conditions shall remain in full force and effect while you use the Site or Services or are otherwise a user of the Site, as applicable. You may terminate your use or participation at any time, for any reason, by following the instructions for terminating user accounts in your account settings, if available, or by contacting us at sociolinkage@gmail.com.</li>
                                            <li>
                        ...
                        If we determine, in our sole discretion, that your use of the Site/Services is in breach of these Terms and Conditions or of any applicable law or regulation, we may terminate your use or participation in the Site and the Services or delete your profile and any content or information that you posted at any time, without warning, in our sole discretion.
                                    ...
                                    <li>
                                        <h3 className="content-sub-head">General</h3>
                                        <ol>
                                            <li>
                            ...
                            You hereby agree to the use of electronic signatures, contracts, orders and other records and to electronic delivery of notices, policies and records of transactions initiated or completed by us or via the Site. You hereby waive any rights or requirements under any statutes, regulations, rules, ordinances or other laws in any jurisdiction which require an original signature or delivery or retention of non-electronic records, or to payments or the granting of credits by other than electronic means.
                                            ...
                                            <li>
                                                In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at sociolinkage@gmail.com or by post to:
                            </li>
                                        </ol>
                                    </li>
                                </ol>
                                <p>
                                    Socio-Linkage
                                    C-22,Nazish Heaven, Block-11, Gulshan-e-Iqbal,Karachi
                                    Karachi,   Sindh 75300
                                    Pakistan
                        </p>
                            </section>
